---
permalink: /
title: "Welcome to my personal website/portfolio"
author_profile: true
redirect_from: 
  - /about/
  - /about.html
...
About Me / Background
------
I'm from South Florida, and I currently live in Tallahassee while I work on my Bachelor of Science degree in Statistics, with minors in Computational Science and Psychology.

I enjoy nerdy stuff like underground rap music and minimal ambient music, coffee and london fog teas, and walks through nature with my girlfriend.

My goal is to earn a Ph.D. in Computational Neuroscience, or Neuroscience/Statistics, and exploring if psychiatric symptoms emerge under proposed causes within an embodied virtual sensorimotor agent which is constrained to experimental neural data. 

My journey into computational neuroscience began during a summer internship at Carnegie Mellon University in computational neuroscience in 2024 working under the guidance of Timothy Verstynen, Ph.D. and Ph.D. Candidate Jack Burgess, where I mainly got familiar with the general basics of computational science such as using the command line interface and conda environments, working on a project using a CBGT Reinforcement Learning agent evaluated for transfer learning in playing board games with different mathematically optimal strategies.
